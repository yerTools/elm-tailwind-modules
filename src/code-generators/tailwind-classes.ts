    ...
    return [
        generate.elmModuleHeader({
            ...
            imports: [
                ...
                generate.singleLine("import Html.Styled.Attributes"),
                generate.singleLine("import Html.Styled"),
            ],
...
${elmClassName} : List (Html.Styled.Attribute msg)
${elmClassName} =
    [ Html.Styled.Attributes.class ${JSON.stringify(propertiesBlock.originalClassName)}
    , Html.Styled.Attributes.css [ Tw.${elmClassName} ]
    ]
`;
}
...
${elmClassName} : List (Html.Styled.Attribute msg)
${elmClassName} =
    [ Html.Styled.Attributes.class ${JSON.stringify(originalClassName)} ]
`;
}